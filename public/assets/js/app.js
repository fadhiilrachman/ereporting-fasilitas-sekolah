require.config({
    shim: {
        ...
        'datatables': ['bootstrap', 'jquery', 'datatables.net-bs'],
    ...
    paths: {
        ...
        'jquery-ui': 'js/vendors/jquery-ui.min',
        'jquery-ui-i18n': 'js/vendors/jquery-ui-i18n.min',
        ...
        'moment_id': 'js/vendors/moment-locale-id.min',
        'validate': 'js/vendors/jquery.validate.min',
        'datatables': 'vendors/DataTables/dataTables.bootstrap4.min',
        'datatables.net' : 'vendors/DataTables/DataTables-1.10.20/js/jquery.dataTables.min',
        'datatables.net-bs' : 'vendors/DataTables/DataTables-1.10.20/js/dataTables.bootstrap.min'
    }
});
window.tabler = {
    colors: {
